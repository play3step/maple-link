...
export default function Notice() {
  ...
  const [notices] = useState<NoticeItem[]>([
    ...
    },
    {
      ...
      content:
        '1. 챌린저스 서버 길드 검색 기능 추가\n' +
        '→ 이제 챌린저스 서버 1, 2, 3, 4의 길드를 검색할 수 있습니다.\n' +
        '→ 메인 페이지 또는 길드 검색 페이지에서 "챌린저스 서버" 선택 시 해당 서버에 등록된 길드를 확인할 수 있습니다.\n\n' +
        '2. 챌린저스 서버 길드 관리 기능 추가\n' +
        '→ 챌린저스 서버 길드도 기존 서버와 동일하게 길드 등록 및 관리가 가능해졌습니다.\n' +
        '→ 길드원 초대, 부캐 등록, 일정 관리 등 모든 기능을 동일하게 사용할 수 있습니다.\n\n' +
        '[주의사항]\n' +
        '→ 챌린저스 서버는 이벤트 서버로, 운영 종료 시 해당 서버에 등록된 길드는 자동으로 삭제됩니다.',
      date: '2025.06.23'
    }
  ])
